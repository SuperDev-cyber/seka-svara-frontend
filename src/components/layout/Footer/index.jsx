...
const Footer = () => {
    return (
        <footer className='main-footer'>
            <div className='footer-content'>
                ...
                <div className='footer-left'>
                    <div className='footer-logo'>
                        <img src={logo} alt='Seka Svara' className='footer-logo-img' />
                    </div>
                    <p className='footer-description'>
                        The premier blockchain card game platform. Play, compete, and win real USDT.
                    </p>
            ...
            {/* Newsletter Section - Positioned below the main content */}
            <div className='newsletter-section'>
                <div className='newsletter-input-container'>
                    ...
                    <button className='newsletter-btn'>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="#2D2D2D">
